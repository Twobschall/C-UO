...
{
    public class Merlin : BaseVendor
    {
        ...
        public Merlin()
            : base("The Mystical")
        { 
            Name = "Merlin"; //Set Vendor's Static Name
            Body = 0x190; // Sets body type to male

            AddItem(new Robe(0x487)); //Black Robe
            CanMove = false; // Prevent Merlin from moving
        }
