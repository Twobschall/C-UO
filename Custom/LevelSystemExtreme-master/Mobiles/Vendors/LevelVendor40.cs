...
{
    public class LevelVendor40 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor40()
            : base("Level 40 Bonus Vender")
        {
        ...
        public LevelVendor40(Serial serial)
            : base(serial)
        {
        }
		...
		public override void VendorBuy(Mobile from)
		{
			...
			if (xmlplayer != null)
			{
				if (this is LevelVendor40)
				{
					if (xmlplayer.Levell < 40)
					{
						Say(true, "You must be level 40 or higher to work with me! Back to Training for you!");
						return;
					}
				}	
			}
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor40());
        }
    ...
    public class SBLevelVendor40 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor40() 
        { 
        }
