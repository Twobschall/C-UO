...
{
    public class LevelVendor90 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor90()
            : base("Level 90 Bonus Vender")
        {
        ...
        public LevelVendor90(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor90());
        }
    ...
    public class SBLevelVendor90 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor90() 
        { 
        }
