...
{
    public class LevelVendor120 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor120()
            : base("Level 120 Bonus Vender")
        {
        ...
        public LevelVendor120(Serial serial)
            : base(serial)
        {
        }
		...
		public override void VendorBuy(Mobile from)
		{
			...
			if (xmlplayer != null)
			{
				if (this is LevelVendor120)
				{
					if (xmlplayer.Levell < 120)
					{
						Say(true, "You must be level 120 or higher to work with me! Back to Training for you!");
						return;
					}
				}	
			}
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor120());
        }
    ...
    public class SBLevelVendor120 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor120() 
        { 
        }
