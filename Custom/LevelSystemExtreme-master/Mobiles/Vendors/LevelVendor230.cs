...
{
    public class LevelVendor230 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor230()
            : base("Level 230 Bonus Vender")
        {
        ...
        public LevelVendor230(Serial serial)
            : base(serial)
        {
        }
		...
		public override void VendorBuy(Mobile from)
		{
			...
			if (xmlplayer != null)
			{
				if (this is LevelVendor230)
				{
					if (xmlplayer.Levell < 230)
					{
						Say(true, "You must be level 230 or higher to work with me! Back to Training for you!");
						return;
					}
				}	
			}
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor230());
        }
    ...
    public class SBLevelVendor230 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor230() 
        { 
        }
