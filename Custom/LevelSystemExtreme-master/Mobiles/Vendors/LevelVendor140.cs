...
{
    public class LevelVendor140 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor140()
            : base("Level 140 Bonus Vender")
        {
        ...
        public LevelVendor140(Serial serial)
            : base(serial)
        {
        }
		...
		public override void VendorBuy(Mobile from)
		{
			...
			if (xmlplayer != null)
			{
				if (this is LevelVendor140)
				{
					if (xmlplayer.Levell < 140)
					{
						Say(true, "You must be level 140 or higher to work with me! Back to Training for you!");
						return;
					}
				}	
			}
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor140());
        }
    ...
    public class SBLevelVendor140 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor140() 
        { 
        }
