...
{
    public class LevelVendor100 : BaseVendor
    {

        private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();
        [Constructable]
        public LevelVendor100()
            : base("Level 100 Bonus Vender")
        {
        ...
        public LevelVendor100(Serial serial)
            : base(serial)
        {
        }
		...
		public override void VendorBuy(Mobile from)
		{
			...
			if (xmlplayer != null)
			{
				if (this is LevelVendor100)
				{
					if (xmlplayer.Levell < 100)
					{
						Say(true, "You must be level 100 or higher to work with me! Back to Training for you!");
						return;
					}
				}	
			}
        ...
        {
            this.m_SBInfos.Add(new SBLevelVendor100());
        }
    ...
    public class SBLevelVendor100 : SBInfo 
    { 
        private readonly List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo();
        private readonly IShopSellInfo m_SellInfo = new InternalSellInfo();
        public SBLevelVendor100() 
        { 
        }
