...
namespace Xanthos.Claim
{
	public class Claim
	{
		...
		public static bool ClaimCorpse( Mobile from, Corpse corpse, ClaimOption option )
		{
			...
			LootCorpse( from, corpse, option, goldBag, lootBag );
		...
		public static void LootCorpse( Mobile from, Corpse corpse, ClaimOption option, Container goldBag, Container lootBag )
		{
