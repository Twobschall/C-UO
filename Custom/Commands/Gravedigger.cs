...
namespace Server.Misc
{
	...
	public static void Gravedigger_Command( CommandEventArgs e )
	{
	    ...
	    mSp.Say ("I will fetch your corpse for a fee of 1,000 gold, just say 'fetch'");
...
namespace Server.Mobiles
{
	...
	public static void GetMyCorpse( Mobile from )
	{
	    ...
	    if (!from.Alive)
	    {
		from.SendMessage("But you are not dead sire, I cannot help thee");
		return;
	    }
	    ...
	    int range = 20000; // 20000 TILES AWAY
	    int HowFarAway = 0;
