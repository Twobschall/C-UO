...
public override string DefaultName
{
    get
    {
        return m_Pet != null ? string.Format("{0} on a leash", Utility.FixHtml(m_Pet.Name)) : "a leashed pet";
    }
}
...
public override void Delete()
{
    ...
    base.Delete();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            {
                list.Add(1061640, (m_Owner != null ? m_Owner.Name : "nobody (WILD)")); // Owner: ~1_OWNER~
