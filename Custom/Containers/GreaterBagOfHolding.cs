...
{
    public class GreaterBagOfHolding : Bag
    {
        [Constructable]
		public GreaterBagOfHolding() : this(36)      // create a 125 item bag by default
		{
		}
		
		[Constructable]
		public GreaterBagOfHolding(int maxitems) : base()
		{
			Weight = 1.0;
			MaxItems = maxitems;
			Name = "Greater Bag of Holding";
			Hue = 1927;
