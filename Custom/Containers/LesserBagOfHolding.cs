...
{
    public class LesserBagOfHolding : Bag
    {
        [Constructable]
		public LesserBagOfHolding() : this(12)      // create a 125 item bag by default
		{
		}
		
		[Constructable]
		public LesserBagOfHolding(int maxitems) : base()
		{
			Weight = 1.0;
			MaxItems = maxitems;
			Name = "Lesser Bag of Holding";
			Hue = 1925;
