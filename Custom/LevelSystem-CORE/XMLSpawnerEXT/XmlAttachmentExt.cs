...
{
	public interface IXmlAttachmentExt
	{
		ASerial Serial { get; }
	...
	public abstract class XmlAttachmentExt : IXmlAttachmentExt
	{
		// ----------------------------------------------
		// Private fields
		// ----------------------------------------------
		...
		*/
		...
		{
			private XmlAttachmentExt m_Attachment;

			public AttachmentTimer(XmlAttachmentExt attachment, TimeSpan delay)
				: base(delay)
			{
		...
		public XmlAttachmentExt()
		{
			...
			XmlAttachExt.HashSerial(m_Serial, this);
		}
